...
$username = getenv('DB_USER') ?: "jssb_trainingjssbpo"; 
$password = getenv('DB_PASS') ?: "Rajendra#2026"; 
$dbname = getenv('DB_NAME') ?: "jssb_jssbpotraining";
...
// ============================================================
// SCHEMA UPDATES - Add QC role to users table (one-time)
// ============================================================
if (empty($_SESSION['_schema_checked'])) {
    $conn->query("ALTER TABLE users MODIFY COLUMN role ENUM('admin','deo','dqc','qc') DEFAULT 'deo'");
