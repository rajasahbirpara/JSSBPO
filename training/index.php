    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="d-flex gap-3 mb-2 align-items-center">
          ...
          <div id="reportImageBadge" style="display:none;">
            <small class="text-muted">Image:</small> 
            <span id="reportImageNo" style="background:#0ea5e9;color:white;padding:1px 7px;border-radius:3px;font-size:12px;"></span>
          </div>
...
function openReportModal(recordNo) {
    ...
    $.post('api.php', {action:'get_image_for_report', record_no: recordNo}, function(res) {
        ...
        if (res.status === 'success' && res.image_no) {
            $('#reportImageNo').text(res.image_no);
...
function submitReportToAdmin() {
    ...
    let imageNoVal = $('#reportImageNo').text() || '';
    $.post('api.php', {
