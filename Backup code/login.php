    ...
    if ($project == 'p1') {
        switch ($role) {
            case 'admin':
                ...
                break;
            case 'supervisor':
                header("Location: p1_admin_dashboard.php"); // supervisor removed
                break;
            case 'qc':
        ...
        switch ($role) {
            case 'admin':
                ...
                break;
            case 'supervisor':
                header("Location: p2_admin_dashboard.php"); // supervisor removed
                break;
            case 'dqc':
    ...
    <script>
        ...
        function p1Login() {
            ...
            $.post('api.php', {
                ...
                btn.prop('disabled', false).html(originalHtml);
                $('#loginMsg').addClass('text-error').text('❌ Server Error. Please try again.');
            });
        }
        ...
        function redirectP1User(role) {
            if (role === 'admin') {
                ...
                window.location.href = 'p1_admin_dashboard.php'; // supervisor removed
            } else if (role === 'qc') {
                window.location.href = 'qc_dashboard.php';
            } else {
